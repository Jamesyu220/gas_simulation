import numpy as np
from temperature import get_v_abs
# @ti.kernel
...
def border_collisions(pos, v, m, dt, xmin, xmax, ymin, ymax, zmin, zmax, heater_xmin, heater_xmax, heater_zmin, heater_zmax, delta_E):
        # Bottom area where the heater affects particles
    heater_xmax = heater_xmin + 0.8
    heater_zmax = heater_zmin + 0.8
